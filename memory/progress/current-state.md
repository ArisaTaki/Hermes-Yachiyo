...
- ✅ 2026-06-06 追加验证：`pytest tests/test_chat_api.py` → 118 passed；`npm --prefix apps/frontend run build` → passed；`git diff --check` → clean。
