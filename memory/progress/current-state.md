...
- ✅ 2026-06-05 追加，2026-06-06 更新：Chat 中手动 `@Workflow` 被引导到 Studio / Runs 时，引导消息会提供动作按钮；若后端能解析出目标 Workflow，会直接跳到 Runs 面板并预选 target / 填入 Goal，否则回退到 Workflow Studio，让 Workflow 触发边界更清晰：群聊协作继续走主模型/Agent，复用流程从 Workflow Studio / Runs 进入。
