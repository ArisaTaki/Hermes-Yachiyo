...
- RunRepository、RunGroupRepository、RunEvent、approval projection、ApprovalCoordinator、ApprovalResumeCoordinator、ApprovalResumeProjectionCoordinator、RunTransitionProjectionCoordinator、WorkflowParentResumeCoordinator、WorkflowCancellationProjectionCoordinator、WorkflowContinuationCoordinator、RunArtifactRepository、tool descriptor 和 policy gate 已开始从 `NativeRunEngine` 中显式拆边界。
