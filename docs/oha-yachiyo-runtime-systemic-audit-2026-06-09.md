...
- Backend import、route registration、standalone packaged backend startup、packaged desktop startup 均已验证；release smoke 现在也覆盖 desktop launcher 启动准备和 shell app entrypoint 到 Electron launcher 的路由。
