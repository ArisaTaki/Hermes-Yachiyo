...
1. 做 PR-3 成熟功能 UI 级回归：
   ...
   - Chat UI 图片附件和审批等待/恢复的浏览器级交互复验；当前图片/审批已有 source Bridge E2E，但还不是完整 UI click/upload/approval-card E2E，取消按钮已有 source Bridge Browser smoke。
