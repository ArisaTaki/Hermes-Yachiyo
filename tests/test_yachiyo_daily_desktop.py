...
def test_planner_first_daily_desktop_entrypoint_verifies_known_app_submit_when_normalized() -> None:
    requests = planner_first_daily_desktop_entrypoint_requests(
...
def test_planner_first_daily_desktop_entrypoint_requests_app_scoped_creation_with_text() -> None:
    ...
    assert planner_first_daily_desktop_entrypoint_requests(
        "帮我打开 Obsidian，新建一条关于今天会议的笔记，标题叫 项目复盘",
        allowed_tools=[
            "desktop.list_apps",
            "app.open_and_safe_shortcut",
            "desktop.safe_type_text",
...
def test_planner_first_daily_desktop_entrypoint_verifies_simple_media_playback() -> None:
    ...
    query_requests = planner_first_daily_desktop_entrypoint_requests(
        "放点周杰伦",
        allowed_tools=[
            "desktop.list_apps",
            "app.open_and_safe_shortcut",
...
def test_daily_desktop_entrypoint_routes_app_blank_new_item_shortcuts() -> None:
    cases = (
        ...
        ("打开日历新建会议", "app.open_and_safe_shortcut", "Calendar", "new_event"),
...
def test_daily_desktop_entrypoint_routes_notes_and_time_first_reminders() -> None:
    ...
    assert daily_desktop_entrypoint_requests("创建明天下午三点和 Alice 的日程") == [
        {
            "protocol": "json_fallback",
            "tool": "calendar.create_event",
            "input": {
...
def test_daily_desktop_entrypoint_routes_music_app_playback_questions_to_desktop_tools(
    ...
    cases = (
        ...
        ("能帮我播放 Apple Music 吗", "media.music_app_open_and_play", {"app_name": "Music"}),
        ("能不能直接播个 Apple Music", "media.music_app_open_and_play", {"app_name": "Music"}),
        ("把 Apple Music 打开然后播放", "media.music_app_open_and_play", {"app_name": "Music"}),
        ("Apple Music 随便播一首", "media.music_app_open_and_play", {"app_name": "Music"}),
        ("让 Apple Music 播放", "media.music_app_open_and_play", {"app_name": "Music"}),
        ("请 Apple Music 播放", "media.music_app_open_and_play", {"app_name": "Music"}),
        ("你能不能帮我播放音乐", "media.music_app_open_and_play", {"app_name": "Music"}),
        ("帮我在 Apple Music 播放点音乐", "media.music_app_open_and_play", {"app_name": "Music"}),
        ("打开音乐听听", "media.music_app_open_and_play", {"app_name": "Music"}),
        ("音乐听听", "media.music_app_open_and_play", {"app_name": "Music"}),
        ("打开音乐听一下", "media.music_app_open_and_play", {"app_name": "Music"}),
        ("can you play some music?", "media.music_app_open_and_play", {"app_name": "Music"}),
        ("put on some music", "media.music_app_open_and_play", {"app_name": "Music"}),
