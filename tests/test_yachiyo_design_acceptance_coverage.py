...
def test_hanako_hermes_runtime_roadmap_is_guarded() -> None:
    _assert_contains(
        ...
        [
            ...
            "minimum bar is parity with the Hanako/Hermes class of products",
            "packaged, installed, smoke-tested",
            "Packaging, signing/notarization or documented unsigned install flow",
            "First-run onboarding explains Screen Recording, Accessibility, Automation",
            "Demo scripts show Hanako/Hermes-level flows",
