...
def test_launcher_views_expose_session_summary_e2e_selectors() -> None:
    ...
    _assert_contains(
        "apps/frontend/src/features/yachiyo-chat/taskPlannerSummary.ts",
        [
            "export type TaskPlannerSummarySnapshot",
            "export type TaskPlannerSummaryChip",
            "export function plannerSummaryFromTask",
            "export function plannerSummaryDetail",
            "export function plannerSummaryChips",
            "plannerSummaryFromStructuredTrace(task.planner_summary)",
            ...
            "compose.${key}",
            "metadata.yachiyo_runtime_planner",
            "metadata.yachiyo_plan_tools",
            "metadata.yachiyo_plan_capabilities",
        ],
    )
    ...
    _assert_contains(
        ...
        [
            ...
            ".launcher-agent-task-planner",
            ".launcher-agent-task-main .launcher-agent-task-planner-chip",
            ".bubble-shell .launcher-agent-task-main .launcher-agent-task-planner-chip",
        ],
    )
    _assert_contains(
        "apps/frontend/src/views/OpenDesignView.tsx",
...
def test_chat_ui_preserves_sessions_groups_attachments_and_approval_paths() -> None:
    _assert_contains(
        ...
        [
            ...
            "result.mode === 'replan'",
            "result.mode === 'desktop_provider_session'",
...
def test_chat_renders_yachiyo_agent_task_card_entrypoint() -> None:
    ...
    _assert_contains(
        ...
        [
            ...
            "function messageArrayMetadataValue",
    ...
    _assert_contains(
        ...
        [
            ...
            "data-desktop-execution-route-session-policy",
            ...
            "data-sandbox-provider-requires-real-sandbox-for",
            ...
            "runtimeRequestReplayEvidenceFromRequest(request)",
    ...
    _assert_contains(
        "apps/frontend/src/features/runtime-shared/components/RuntimeRequestReplayEvidencePanel.tsx",
        [
    ...
    _assert_contains(
        "apps/frontend/src/features/runtime-shared/runtimeAnchors.ts",
        [
            "export type RuntimeAnchorKind",
            "export function runtimeAnchorId",
            "export function runtimeAnchorSelector",
    ...
    _assert_contains(
        ...
        [
            ...
            ".runtime-recovery-evidence-panel button",
            ".runtime-recovery-evidence-panel button:focus-visible",
            "[data-runtime-anchor-active=\"true\"]",
    ...
    _assert_contains(
        ...
        [
            ...
            "export function runtimeEventIsDesktopForegroundSessionNotice",
    ...
    _assert_contains(
        "apps/frontend/src/features/runtime-shared/desktopProviderSessionEvents.ts",
        [
            ...
            "runtimeEventIsDesktopProviderSessionEvent(eventType, 'failed')",
            "runtimeEventIsDesktopProviderSessionEvent(eventType, 'started')",
            "runtimeEventIsDesktopProviderSessionEvent(eventType, 'ready')",
            "runtimeEventIsDesktopProviderSessionEvent(eventType, 'required')",
            ...
            "context.toolNames.map(runtimeToolDisplayLabelOrName).join(' -> ')",
            "context.supportedTools.map(runtimeToolDisplayLabelOrName).join(' -> ')",
        ],
    )
    _assert_contains(
    ...
    _assert_contains(
        ...
        [
            ...
            "approvalPreviewRecord(approval.action_target)",
            "approvalPreviewRecord(approval.observation_evidence)",
            "approvalPreviewRecord(approval.observation_retry)",
    ...
    _assert_contains(
        ...
        [
            ...
            "runtimeDesktopProviderBackendSummary(context)",
            "runtimeDesktopProviderSafetySummary(context)",
            "runtimeDesktopProviderManifestSummary(context)",
            ...
            "runtimeDesktopProviderSessionContext(event, payloadRecord)",
    ...
    _assert_contains(
        ...
        [
            ...
            "runtimeRecoveryActionIsDesktopProviderSessionStart(action)",
            ...
            "desktopProviderSessionCanContinue(providerSession)",
            "已继续原任务",
    ...
    _assert_contains(
        "apps/frontend/src/features/runtime-shared/desktopProviderSessionRecovery.ts",
        [
            "export function runtimeRecoveryActionIsDesktopProviderSessionStart",
            "action.tool === 'desktop.provider_session.start'",
    ...
    _assert_contains(
        ...
        [
            ...
            "runtimeToolDisplayLabelOrName",
            "capabilities.sandbox_provider",
            "desktop_provider_ready",
            "desktop_provider_supported_tools",
            "desktop_provider_requires_real_sandbox_for",
...
def test_agent_studio_exposes_yachiyo_public_group_entrypoint() -> None:
    _assert_contains(
        ...
        [
            ...
            "getYachiyoStudioDesktopProviderSession",
            "startYachiyoStudioDesktopProviderSession",
    ...
    _assert_contains(
        ...
        [
            ...
            "data-testid=\"studio-legacy-cleanup-areas\"",
            "data-testid=\"studio-legacy-cleanup-contracts\"",
            "data-testid=\"studio-legacy-cleanup-owned-entrypoints\"",
            "data-testid=\"studio-legacy-cleanup-fallbacks\"",
            "data-testid=\"studio-legacy-cleanup-prompts\"",
            ...
            "data-testid=\"studio-tool-provider-state\"",
    ...
    _assert_contains(
        ...
        [
            ...
            "startYachiyoStudioDesktopProviderSession(",
            "desktopProviderSessionStartRequestFromAction(action)",
            "desktopProviderSessionCanContinue(session)",
            "已继续恢复 Run",
            "已继续 GroupRun 恢复 Run",
            "startYachiyoRunReplanRecoveryAction(runId, request)",
            "startYachiyoGroupRunReplanRecoveryAction(groupRunId, request)",
            "studioNextAutoReplanContinuation(",
            "startYachiyoRunNextReplanContinuation(candidate.targetId, candidate.request)",
            "startYachiyoGroupRunNextReplanContinuation(candidate.targetId, candidate.request)",
...
def test_agent_studio_uses_extracted_runtime_shared_components() -> None:
    ...
    _assert_contains(
        ...
        [
            ...
            "data-execution-strategy-mitigation={mitigation}",
            ...
            "function mergedVerificationTargetRecords",
    ...
    _assert_contains(
        ...
        [
            ...
            "action_target?: Record<string, unknown>;",
            "runtimeToolTraceRecord(toolCall, 'action_target')",
            "runtimeToolTraceRecord(toolCall, 'observation_evidence')",
            "runtimeToolTraceRecord(toolCall, 'observation_retry')",
    ...
    _assert_contains(
        ...
        [
            ...
            "runtimeToolRecoveryAutoStartContext(action, source)",
...
def test_chat_image_attachment_ui_smoke_uses_file_input_path() -> None:
    ...
    _assert_contains(
        ...
        [
            ...
            "Chat UI did not submit the image message through /yachiyo/tasks",
            "Chat UI fell back to legacy /ui/chat/messages",
            "Chat UI did not submit client_message_id for image task idempotency",
            "payload.agent_id !== 'builtin:yachiyo-main'",
            "payload.metadata?.attachment_count !== CHAT_IMAGE_SMOKE_FILE_NAMES.length",
...
def test_chat_approval_run_detail_handoff_preserves_route_and_replay_wiring() -> None:
    _assert_contains(
        ...
        [
            ...
            "onOpenComposerApprovalDetails={() => {",
            "if (composerApprovalItem) openRunDetails(composerApprovalItem.runId);",
            "autoReplanContinuationKeysRef",
            "yachiyoTaskNextAutoReplanContinuation(task",
            "startYachiyoTaskNextReplanContinuation(taskId, candidate.request)",
        ],
    )
    _assert_contains(
        "apps/frontend/src/features/yachiyo-chat/components/MessageBubble.tsx",
