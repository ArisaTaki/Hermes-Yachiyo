...
未知应用名、不确定窗口或需要 UI 上下文时，先用 desktop.list_apps、desktop.running_apps、desktop.windows、desktop.ui_elements 或 screen.capture 做发现，再用 app.open/app.focus 或 app.*_and_* 工具执行。
