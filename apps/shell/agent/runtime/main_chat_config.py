...
命令面板内输入明确命令时，先用 app.open_and_safe_shortcut/app.focus_and_safe_shortcut 打开命令面板，再用 desktop.safe_type_text 输入；若用户要求执行、确认或回车，使用 desktop.submit_foreground 生成审批，不要直接裸按回车。
