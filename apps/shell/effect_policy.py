...
_FIELD_POLICIES: dict[str, tuple[EffectType, str]] = {
    ...
    "live2d.enable_expressions": (EffectType.IMMEDIATE,
                                  "表情系统设置已更新"),
    "live2d.expression_keywords": (EffectType.IMMEDIATE,
                                   "表情关键词映射已更新"),
    "live2d.enable_physics":     (EffectType.IMMEDIATE,
                                  "物理模拟设置已更新"),
    "live2d.mouse_follow_enabled": (EffectType.IMMEDIATE,
                                    "鼠标跟随偏好已更新"),
    "live2d.render_quality_preset": (EffectType.REQUIRES_MODE_RESTART,
                                     "Live2D 画质预设将在重启该模式后生效"),
    "live2d.render_fps":       (EffectType.REQUIRES_MODE_RESTART,
                                "Live2D 帧率限制将在重启该模式后生效"),
    "live2d.render_resolution": (EffectType.REQUIRES_MODE_RESTART,
                                 "Live2D 清晰度限制将在重启该模式后生效"),
    "live2d.hit_region_precision": (EffectType.REQUIRES_MODE_RESTART,
                                    "Live2D 透明命中精度将在重启该模式后生效"),
    ...
    "live2d_mode.height":             (EffectType.REQUIRES_MODE_RESTART,
                                       "Live2D 窗口尺寸将在重启该模式后生效"),
    "live2d_mode.position_anchor":    (EffectType.REQUIRES_MODE_RESTART,
                                       "Live2D 默认位置锚点将在重启该模式后生效"),
    ...
    "live2d_mode.mouse_follow_enabled": (EffectType.IMMEDIATE,
                                         "鼠标跟随偏好已更新"),
    "live2d_mode.render_quality_preset": (EffectType.REQUIRES_MODE_RESTART,
                                          "Live2D 画质预设将在重启该模式后生效"),
    "live2d_mode.render_fps":       (EffectType.REQUIRES_MODE_RESTART,
                                     "Live2D 帧率限制将在重启该模式后生效"),
    "live2d_mode.render_resolution": (EffectType.REQUIRES_MODE_RESTART,
                                      "Live2D 清晰度限制将在重启该模式后生效"),
    "live2d_mode.hit_region_precision": (EffectType.REQUIRES_MODE_RESTART,
                                         "Live2D 透明命中精度将在重启该模式后生效"),
    "live2d_mode.idle_motion_group":  (EffectType.IMMEDIATE,
                                       "待机动作组已更新"),
    "live2d_mode.enable_expressions": (EffectType.IMMEDIATE,
                                       "表情系统设置已更新"),
    "live2d_mode.expression_keywords": (EffectType.IMMEDIATE,
                                        "表情关键词映射已更新"),
