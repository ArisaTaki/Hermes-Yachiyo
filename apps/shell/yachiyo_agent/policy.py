...
DESKTOP_ACTION_TOOL_HINTS: dict[str, tuple[str, ...]] = {
    ...
    "foreground_search_submit": ("desktop.search_submit",),
...
DESKTOP_ACTION_TITLES: dict[str, str] = {
    ...
    "open_path_with_app": "Open local path with app",
    ...
    "foreground_search_submit": "Submit foreground search",
...
DESKTOP_ACTION_DESCRIPTIONS: dict[str, str] = {
    ...
    "open_path_with_app": "Open a safe local file or folder with a discovered desktop application.",
    ...
    "foreground_search_submit": "Press Return only to submit an explicit foreground search/find query, not to send messages or submit forms.",
