...
def _fallback_notes_for_tool(tool_name: str) -> list[str]:
    notes_by_tool = {
        ...
        "desktop.safe_shortcut": [
            "Requires Accessibility permission and only accepts whitelisted common shortcut actions, including copy current page link, app switching, hide other apps, toggle full screen, new window, and browser back/forward.",
        ],
        "desktop.safe_key": [
