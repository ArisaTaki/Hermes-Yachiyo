...
class RuntimePort(Protocol):
    ...
    def get_task_event_stream(self, task_id: str) -> Iterable[dict[str, Any]] | Mapping[str, Any]: ...
...
class StudioPort(Protocol):
    ...
    def list_restricted_tool_plugins(self) -> list[dict[str, Any]] | Mapping[str, Any]: ...

    def install_restricted_tool_plugin(self, request: dict[str, Any]) -> dict[str, Any]: ...

    def update_restricted_tool_plugin(self, plugin_id: str, request: dict[str, Any]) -> dict[str, Any]: ...
