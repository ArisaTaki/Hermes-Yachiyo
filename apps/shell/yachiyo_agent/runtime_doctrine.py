...
YACHIYO_RUNTIME_DOCTRINE = (
    ...
    "smallest explicit action, then observe the result. Prefer structured tools over terminal.run unless the task "
    "is code, data, file organization, or explicitly requires a command. Persist durable outputs as artifacts. "
