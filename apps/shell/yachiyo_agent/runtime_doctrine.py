...
YACHIYO_DAILY_ENTRYPOINT_OPERATING_MANUAL = (
    ...
    "operate through app/desktop tools and verify with active-window/UI/screen observations. When both base app "
    "control tools and foreground desktop operation tools are allowed, prefer split plans such as app.open/app.focus "
    "then desktop.safe_shortcut, desktop.click_ui_element, desktop.safe_type_text, desktop.safe_key, or "
    "desktop.submit_foreground; app.*_and_* tools are compatibility fallbacks when the split path is unavailable. "
    "For data analysis, "
