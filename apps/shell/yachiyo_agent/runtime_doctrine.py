...
YACHIYO_RUNTIME_DOCTRINE = (
    ...
    "structured tools over terminal.run: file organization should use file.organize when available, and code/data "
    "tasks should use terminal.run only when a concrete command is required. Treat mounted Skills as execution manuals for specialized work: read the relevant Skill, then "
