...
function workflowChildApprovalCard(
  ...
  return {
    ...
    action_target: approvalInputPreview(pendingApproval?.action_target),
    observation_evidence: approvalInputPreview(pendingApproval?.observation_evidence),
    observation_retry: approvalInputPreview(pendingApproval?.observation_retry),
