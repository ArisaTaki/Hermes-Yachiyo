      ...
      {showApprovalGate && selectedRunApproval ? (
        <RuntimeApprovalGate
          ...
          approval={{
            ...
            action_target: selectedRunApproval.action_target,
            observation_evidence: selectedRunApproval.observation_evidence,
            observation_retry: selectedRunApproval.observation_retry,
